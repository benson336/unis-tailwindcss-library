    ...
    return(
        ...
        <div class="bg-gray-50 rounded-lg justify-around items-top relative" style={{"width":"100%", "height":"850px" ,"border":"1px solid rgb(229 231 235)"}}>
            ...
            <div class="flex justify-around items-center text-center rounded-lg" style={{"width":"100%", "height":"10%"}}>
                ...
                <div style={{"border":"1px solid rgb(229 231 235)", "cursor":"pointer"}} class="px-2 py-1 flex justify-center items-center font-medium rounded-lg bg-white 
                hover:bg-gray-100 text-gray-900 hover:text-blue-700" onClick={toggleShow}>
                    <svg class="ml-2 mr-2" width={13} height={15} viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                        <path
                ...
                <div class="flex">
                    <div style={{"border":"1px solid rgb(229 231 235)", "cursor":"pointer"}} class="px-2 py-2 flex justify-center items-center font-medium rounded-lg bg-white 
                    ...
                    <div style={{"border":"1px solid rgb(229 231 235)", "cursor":"pointer"}} class="ml-4 px-2 py-2 flex justify-center items-center font-medium rounded-lg bg-white 
                    hover:bg-gray-100 text-gray-900 hover:text-blue-700 px-2 py-1">
                        <div class="text-xs">
                ...
                <div style={{"border":"1px solid rgb(229 231 235)", "cursor":"pointer"}} class="px-2 py-2 relative z-30 flex justify-center items-center font-medium rounded-lg bg-white hover:bg-gray-100 text-gray-900 hover:text-blue-700">
                    ...
                    <div class={"px-3 py-2 rounded " + props.selectedColor} onClick={props.toggleColor}></div>
                    ...
                    <div class="bg-white absolute right-0 top-0 mt-10 h-72 w-80 rounded-lg" style={{"border":"1px solid rgb(229 231 235)"}}>
                        ...
                        <div class="flex justify-evenly items-center flex-wrap mt-2">
                            <div class="px-2 py-0.2 rounded bg-blue-50" onClick={props.changeColor} value="bg-blue-100">50</div>
                            <div class="px-2 py-0.2 rounded bg-blue-100" onClick={props.changeColor} value="bg-blue-100">100</div>
                            <div class="px-2 py-0.2 rounded bg-blue-200" onClick={props.changeColor} value="bg-blue-200">200</div>
                            <div class="px-2 py-0.2 rounded bg-blue-300" onClick={props.changeColor} value="bg-blue-300">300</div>
                            <div class="px-2 py-0.2 rounded bg-blue-400" onClick={props.changeColor} value="bg-blue-400">400</div>
                            <div class="px-2 py-0.2 rounded bg-blue-500" onClick={props.changeColor} value="bg-blue-500">500</div>
                        </div>
                        <div class="flex justify-evenly items-center flex-wrap mt-2 mb-2">
                            <div class="px-2 py-0.2 rounded bg-sky-50" onClick={props.changeColor} value="bg-sky-100">50</div>
                            <div class="px-2 py-0.2 rounded bg-sky-100" onClick={props.changeColor} value="bg-sky-100">100</div>
                            <div class="px-2 py-0.2 rounded bg-sky-200" onClick={props.changeColor} value="bg-sky-100">200</div>
                            <div class="px-2 py-0.2 rounded bg-sky-300" onClick={props.changeColor} value="bg-sky-100">300</div>
                            <div class="px-2 py-0.2 rounded bg-sky-400" onClick={props.changeColor} value="bg-sky-100">400</div>
                            <div class="px-2 py-0.2 rounded bg-sky-500" onClick={props.changeColor} value="bg-skye-100">500</div>
                        </div>
                        <div class="flex justify-evenly items-center flex-wrap mt-2">
                            <div class="px-2 py-0.2 rounded bg-teal-50" onClick={props.changeColor} value="bg-teal-100">50</div>
                            <div class="px-2 py-0.2 rounded bg-teal-100" onClick={props.changeColor} value="bg-teal-100">100</div>
                            <div class="px-2 py-0.2 rounded bg-teal-200" onClick={props.changeColor} value="bg-teal-100">200</div>
                            <div class="px-2 py-0.2 rounded bg-teal-300" onClick={props.changeColor} value="bg-teal-100">300</div>
                            <div class="px-2 py-0.2 rounded bg-teal-400" onClick={props.changeColor} value="bg-teal-100">400</div>
                            <div class="px-2 py-0.2 rounded bg-teal-500" onClick={props.changeColor} value="bg-teal-100">500</div>
                        </div>
                        <div class="flex justify-evenly items-center flex-wrap mt-2">
                            <div class="px-2 py-0.2 rounded bg-gray-50" onClick={props.changeColor} value="bg-gray-100">50</div>
                            <div class="px-2 py-0.2 rounded bg-gray-100" onClick={props.changeColor} value="bg-gray-100">100</div>
                            <div class="px-2 py-0.2 rounded bg-gray-200" onClick={props.changeColor} value="bg-gray-100">200</div>
                            <div class="px-2 py-0.2 rounded bg-gray-300" onClick={props.changeColor} value="bg-gray-100">300</div>
                            <div class="px-2 py-0.2 rounded bg-gray-400" onClick={props.changeColor} value="bg-gray-100">400</div>
                            <div class="px-2 py-0.2 rounded bg-gray-500" onClick={props.changeColor} value="bg-gray-100">500</div>
                        </div>
                        <div class="flex justify-evenly items-center flex-wrap mt-2">
                            <div class="px-2 py-0.2 rounded bg-night-50" onClick={props.changeColor} value="bg-night-100">50</div>
                            <div class="px-2 py-0.2 rounded bg-night-100" onClick={props.changeColor} value="bg-night-100">100</div>
                            <div class="px-2 py-0.2 rounded bg-night-200" onClick={props.changeColor} value="bg-night-100">200</div>
                            <div class="px-2 py-0.2 rounded bg-night-300" onClick={props.changeColor} value="bg-night-100">300</div>
                            <div class="px-2 py-0.2 rounded bg-night-400" onClick={props.changeColor} value="bg-night-100">400</div>
                            <div class="px-2 py-0.2 rounded bg-night-500" onClick={props.changeColor} value="bg-night-100">500</div>
                        </div>
                        <div class="flex justify-evenly items-center flex-wrap mt-2"> 
                            <div class="px-2 py-0.2 rounded bg-red-50" onClick={props.changeColor} value="bg-red-100">50</div>
                            <div class="px-2 py-0.2 rounded bg-red-100" onClick={props.changeColor} value="bg-red-100">100</div>
                            <div class="px-2 py-0.2 rounded bg-red-200" onClick={props.changeColor} value="bg-red-100">200</div>
                            <div class="px-2 py-0.2 rounded bg-red-300" onClick={props.changeColor} value="bg-red-100">300</div>
                            <div class="px-2 py-0.2 rounded bg-red-400" onClick={props.changeColor} value="bg-red-100">400</div>
                            <div class="px-2 py-0.2 rounded bg-red-500" onClick={props.changeColor} value="bg-red-100">500</div>
                        </div>
                    </div> : null}
                </div>
            </div>
