...
export default function EcommerceTwo(){
    ...
    let ecommerceTwoComp = (
                ...
                <div className="bg-gray-50 rounded-xl" style={{"width":"300px", "height":"auto"}}>
                    <div className="w-full py-4 px-4 flex justify-start items-center">
                        <div className="w-1/2 flex justify-start items-center">
                            <h2 className={"p-0 m-0 " + ecommerceTwoState.selectedFont}>Title</h2>
                        </div>
        ...
        let ecommerceTwoCompString = '<div class="flex justify-start items-center border rounded-xl" style={{"width":"356px", "height":"80px"}}><div class="ml-4"><p class="w-8 h-8 p-0 m-0 text-base font-medium text-center text-[#1c1e33] rounded-full ' + ecommerceTwoState.selectedColor +'">A</p></div><div class="ml-4 leading-normal"><h4 class="p-0 m-0 font-bold ' + ecommerceTwoState.selectedFont + '">Header</h4><p class="p-0 m-0 ' + ecommerceTwoState.selectedFont + '">Subheader</p></div><div class="ml-36"><img src="vvv.png" class="w-20 h-20 m-0 p-0 object-cover border rounded-r-xl" /></div></div>'
